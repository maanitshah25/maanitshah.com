...
const Hero = () => {
    return (
        <section className="min-h-screen text-center p-10 mt-4">
            <div className="relative mx-auto w-64 h-64 mt-16 bg-transparent transition duration-300 ease-in-out">
                <Image src={Myself} alt="" className="rounded-full" />
            </div>
            <h2 className="text-4xl py-1 text-black dark:text-white font-semibold font-serif">
                Hello, I am Maanit
            </h2>
            ...
            <p className="text-lg py-4 leading-8 text-black dark:text-white max-w-3xl mx-auto font-serif">
